  ...
  return (
    <div>
      ...
      <div className='content'>
        <div className='con1'>
          <form className='name'>
            <input className='input' value={input1Value} placeholder='Player1 - X' onChange={(e) => setInput1Value(e.target.value)} /><br />
            <input className='input' value={input2Value} placeholder='Player2 - O' onChange={(e) => setInput2Value(e.target.value)} /><br />
